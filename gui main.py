...
root.title("AI generated text detector ")
w,h = root.winfo_screenwidth(),root.winfo_screenheight()

bg = Image.open(r"5.jpg")
...
wlcm=tk.Label(root,text="......Welcome to AI generated text detector System ......",width=95,height=3,background="#212F3D",foreground="white",font=("Times new roman",22,"bold"))
