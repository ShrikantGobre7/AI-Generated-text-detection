...
###########################################################################################################
lbl = tk.Label(root, text="Detect AI Generated Text ", font=('Georgia', 40,' bold '), height=1, width=45,bg="lightgreen",fg="black")
lbl.place(x=0, y=0)
##############################################################################################################################
...
def Data_Display():
    ...
    data1 = pd.read_csv(r"Training_Essay_Data.csv", encoding='unicode_escape')
...
def Train():
    ...
    result = pd.read_csv(r"Training_Essay_Data.csv")
...
frame = tk.LabelFrame(root,text="Control Panel",width=250,height=450,bd=3,background="darkgray",foreground="black",font=("Tempus Sanc ITC",15,"bold"))
...
#     print(y_predict[0])
#     if y_predict[0]==0:
#         label4 = tk.Label(root,text ="Human Generated Text",width=40,height=2,bg='#46C646',fg='black',font=("Tempus Sanc ITC",25))
#         label4.place(x=450,y=550)
#     else:
        
#         label4 = tk.Label(root,text ="AI Generated Text",width=40,height=2,bg='#FF3C3C',fg='black',font=("Tempus Sanc ITC",25))
#         label4.place(x=450,y=550)
...
button1 = tk.Button(frame,command=Data_Display,text="Data Display",bg="antiquewhite",fg="black",width=15,font=("Times New Roman",15,"bold"))
button1.place(x=20,y=50)

button2 = tk.Button(frame,command=Train,text="Train",bg="antiquewhite",fg="black",width=15,font=("Times New Roman",15,"bold"))
button2.place(x=20,y=130)

button3 = tk.Button(frame,command=Test,text="Test",bg="antiquewhite",fg="black",width=15,font=("Times New Roman",15,"bold"))
button3.place(x=20,y=210)

button4 = tk.Button(frame,command=window,text="Exit",bg="#CD5B45",fg="black",width=15,font=("Times New Roman",15,"bold"))
